function ModalAddGood({newGoodRef, goodTitle, goodTitleOnChange, goodPrice, goodPriceOnChange, goodsCount, goodsCountOnChange, goodSaveHandler}) {
  return (
    <div ref={newGoodRef} className="modal fade" id="exampleModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div className="modal-dialog">
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <button type="submit" className="btn btn-success" onClick={goodSaveHandler}>Сохранить</button>
          </div>
        </div>
      </div>
    </div>
